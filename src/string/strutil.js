 ...
 */
export function strJoin(arrOfStrings, sep='') {
 ...
 */
export function reverse(s) { // 1100ms
	let o = '';
 ...
 */
export function prefixHead(a,b) {
 ...
 */
export function prefixTail(a,b) {
 ...
 *
 */
export function padTo(padLength, padChar='0') {
	let maxNum = 10, 
		padding = ''; 
 ...
 */
export function countCh(data, char, arr, start, end) {
